...
export const snackMore: Recipe[] = [
  ...
  },
  {
    ...
    title: "Cheese and Rice Cakes (Not-HA)",
    mealType: "snack",
    cuisine: "american",
    specialOccasion: false,
    ha: "not-ha-assumed",
    ...
    eatOut: false,
    relatedRecipeIds: ["cheese-and-rice-cakes-ha"],
    prepMinutes: 5,
    cookMinutes: 0,
    servings: 2,
    ingredients: [
  ...
  },
  {
    ...
    title: "Apple and Peanut Butter (Not-HA)",
    mealType: "snack",
    cuisine: "american",
    specialOccasion: false,
    ha: "not-ha-assumed",
  ...
  },
  {
    ...
    healthRating: "moderate",
    eatOut: false,
    relatedRecipeIds: ["salsa-and-chips-ha"],
    prepMinutes: 2,
    cookMinutes: 0,
    servings: 4,
    ingredients: [
  ...
  },
  {
    ...
    healthRating: "moderate",
    eatOut: false,
    relatedRecipeIds: ["yogurt-cup-ha"],
    prepMinutes: 3,
    cookMinutes: 0,
    servings: 1,
    ingredients: [
    ...
    steps: [
      "Spoon the Greek yogurt into a cup.",
  ...
  },
  {
    ...
    healthRating: "healthy",
    eatOut: false,
    relatedRecipeIds: ["granola-clusters-ha"],
    prepMinutes: 10,
    cookMinutes: 20,
    servings: 8,
    ingredients: [
    ...
    steps: [
      ...
      "Pour in the coconut oil and honey and toss until everything looks damp.",
  ...
  },
  {
    ...
    healthRating: "healthy",
    eatOut: false,
    relatedRecipeIds: ["energy-bites-ha"],
    prepMinutes: 15,
    cookMinutes: 0,
    servings: 12,
    ingredients: [
  ...
  },
  {
    ...
    healthRating: "unhealthy",
    eatOut: false,
    relatedRecipeIds: ["cheese-crisps-ha"],
    prepMinutes: 5,
    cookMinutes: 8,
    servings: 4,
    ingredients: [
    ...
    steps: [
      ...
      "Drop small piles of shredded cheddar on the parchment, spaced apart.",
  ...
  },
  {
    ...
    title: "Banana and Peanut Butter (Not-HA)",
    mealType: "snack",
    cuisine: "american",
    specialOccasion: false,
    ha: "not-ha-assumed",
  ...
  },
  {
    ...
    healthRating: "unhealthy",
    eatOut: false,
    relatedRecipeIds: ["snack-nachos-ha"],
    prepMinutes: 5,
    cookMinutes: 8,
    servings: 2,
    ingredients: [
    ...
    steps: [
      ...
      "Scatter cheddar over the chips.",
  ...
  },
  {
    ...
    title: "Cottage Cheese Snack (Not-HA)",
    mealType: "snack",
    cuisine: "american",
    specialOccasion: false,
    ha: "not-ha-assumed",
  ...
  },
  {
    ...
    title: "Roasted Pumpkin Seeds (HA)",
    mealType: "snack",
    cuisine: "american",
    specialOccasion: false,
    ha: "ha-assumed",
  ...
  },
  {
    ...
    title: "Rice Cakes with Avocado (Not-HA)",
    mealType: "snack",
    cuisine: "american",
    specialOccasion: false,
    ha: "not-ha-assumed",
  ...
  },
  {
    ...
    healthRating: "healthy",
    eatOut: false,
    relatedRecipeIds: ["olive-plate-ha"],
    prepMinutes: 5,
    cookMinutes: 0,
    servings: 2,
    ingredients: [
  ...
  },
  {
    ...
    title: "Pickles and Cheese (Not-HA)",
    mealType: "snack",
    cuisine: "american",
    specialOccasion: false,
    ha: "not-ha-assumed",
    healthRating: "moderate",
    eatOut: false,
    relatedRecipeIds: ["pickles-and-cheese-ha"],
    prepMinutes: 3,
    cookMinutes: 0,
    servings: 2,
    ingredients: [
  ...
  },
  {
    ...
    healthRating: "healthy",
    eatOut: false,
    relatedRecipeIds: ["berry-smoothie-ha"],
    prepMinutes: 5,
    cookMinutes: 0,
    servings: 2,
    ingredients: [
    ...
    steps: [
      "Add the Greek yogurt, strawberries, blueberries, and banana to a blender.",
    ...
    ingredients: [
      {
        ...
        amount: 1,
        unit: "bunch",
        preparation: "stems removed, torn",
      },
      {
        ingredientId: "olive-oil",
        amount: 1,
  ...
  },
  {
    ...
    title: "Roasted Carrot Sticks (HA)",
    mealType: "snack",
    cuisine: "american",
    specialOccasion: false,
    ha: "ha-assumed",
  ...
  },
  {
    ...
    title: "Frozen Yogurt Bites (Not-HA)",
    mealType: "snack",
    cuisine: "american",
    specialOccasion: false,
    ha: "not-ha-assumed",
    healthRating: "healthy",
    eatOut: false,
    relatedRecipeIds: ["frozen-yogurt-bites-ha"],
    prepMinutes: 10,
    cookMinutes: 0,
    servings: 4,
    ingredients: [
    ...
    steps: [
      ...
      "Stir the Greek yogurt with honey.",
