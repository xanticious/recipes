...
const coreMealIdeas: MealIdea[] = [
  ...
  },
  {
    ...
    relatedMealIds: ["croissant", "brioche-toast", "english-muffin-and-butter"],
    recipes: [
  ...
  },
  {
    ...
    relatedMealIds: ["pancakes-or-waffles", "french-toast", "tapioca-crepe"],
    recipes: [
  ...
  },
  {
    ...
    relatedMealIds: ["doughnut-and-coffee", "muffin", "pan-dulce"],
    recipes: [
  ...
  },
  {
    ...
    relatedMealIds: ["muffin", "croissant", "crumpets"],
    recipes: [
  ...
  },
  {
    ...
    relatedMealIds: ["eggs-and-toast", "brioche-toast", "rice-cakes-snack"],
    recipes: [
  ...
  },
  {
    ...
    relatedMealIds: ["cereal-and-milk", "yogurt-and-fruit", "granola-bar"],
    recipes: [
  ...
  },
  {
    ...
    relatedMealIds: ["turkey-sandwich", "chicken-salad-lunch"],
    recipes: [
  ...
  },
  {
    ...
    relatedMealIds: ["leftover-rice-bowl-idea", "salmon-and-sides", "kimbap-lunch"],
    recipes: [
  ...
  },
  {
    ...
    relatedMealIds: ["toaster-strudel", "pizza-night", "sausage-roll"],
    recipes: [
  ...
  },
  {
    ...
    relatedMealIds: ["taco-night", "stir-fry-night", "carne-asada-plate"],
    recipes: [
  ...
  },
  {
    ...
    relatedMealIds: ["pasta-marinara", "hot-pocket", "soda-drink"],
    recipes: [
  ...
  },
  {
    ...
    relatedMealIds: ["chili-night", "enchiladas", "tamales-dinner"],
    recipes: [
  ...
  },
  {
    ...
    relatedMealIds: ["pasta-marinara", "fettuccine-alfredo-idea", "gnocchi-idea"],
    recipes: [
      { label: "Pesto Pasta (Not-HA)", recipeId: "pesto-pasta-dinner" },
  ...
  },
  {
    ...
    relatedMealIds: ["fettuccine-alfredo-idea", "salmon-and-sides", "moules-frites"],
  ...
  },
  {
    ...
    relatedMealIds: ["yogurt-cup-snack", "fruit-cup-snack", "rice-cakes-snack"],
    recipes: [
  ...
  },
  {
    ...
    relatedMealIds: ["nachos-lunch", "pretzels", "poutine"],
    recipes: [
  ...
  },
  {
    ...
    relatedMealIds: ["ploughmans-lunch"],
    recipes: [
  ...
  },
  {
    ...
    relatedMealIds: ["trail-mix", "jerky", "edamame"],
    recipes: [
  ...
  },
  {
    ...
    relatedMealIds: ["yogurt-cup-snack", "eggs-and-toast", "jerky"],
  ...
  },
  {
    ...
    relatedMealIds: ["apple-and-peanut-butter-snack", "avocado-toast-idea", "tteokbokki-snack"],
    recipes: [
  ...
  },
  {
    ...
    relatedMealIds: ["nuts-snack", "hummus-and-veg", "potstickers-snack"],
  ...
  },
  {
    ...
    relatedMealIds: ["ice-cream-dessert", "cookies-dessert", "brigadeiro-snack"],
  ...
  },
  {
    ...
    relatedMealIds: ["coffee-drink", "bubble-tea", "barley-tea"],
  ...
  },
  {
    ...
    relatedMealIds: ["breakfast-smoothie", "protein-shake", "bubble-tea"],
    recipes: [
      { label: "Berry Smoothie (Not-HA)", recipeId: "berry-smoothie" },
      { label: "Banana Smoothie (Not-HA)", recipeId: "banana-smoothie" },
    ],
  ...
  },
  {
    ...
    relatedMealIds: ["coffee-drink", "breakfast-smoothie", "agua-fresca"],
